...
export class ObatPindahService {
	...
	allObatPindah: ObatPindah[] = [
		{id: 1, id_jenis: 2138, merek: 'Cefixim syr kering 100mg/5ml', nama_generik: 'Cefixim', pembuat: 'Indofarma', golongan: 'Antibiotik', satuan: 'Botol', harga_jual: 10100.00, nomor_batch: '085G611NV', waktu_masuk: new Date('2016-09-11T16:18+07:00'), kadaluarsa: new Date('2017-06-19'), harga_beli: 9180.36, kode_obat: 213816091102, waktu_keluar: new Date('2017-06-12T08:33+07:00'), jumlah: 5, asal: 'Gudang Utama', tujuan: 'Apotek', keterangan: ''},
		{id: 2, id_jenis: 2138, merek: 'Cefixim syr kering 100mg/5ml', nama_generik: 'Cefixim', pembuat: 'Indofarma', golongan: 'Antibiotik', satuan: 'Botol', harga_jual: 10100.00, nomor_batch: '085G610NV', waktu_masuk: new Date('2016-09-11T16:16+07:00'), kadaluarsa: new Date('2017-06-18'), harga_beli: 9180.36, kode_obat: 213816091101, waktu_keluar: new Date('2017-06-19T09:48+07:00'), jumlah: 37, asal: 'Apotek', tujuan: 'Gudang Utama', keterangan: ''}
	]; // Mock-up
