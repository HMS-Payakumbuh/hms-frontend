...
var DetailObatRusakComponent = (function () {
    ...
    DetailObatRusakComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.obatRusakService.getObatRusak(+params['waktu-keluar']); })
...
DetailObatRusakComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof obat_rusak_service_1.ObatRusakService !== "undefined" && obat_rusak_service_1.ObatRusakService) === "function" && _a || Object, router_1.ActivatedRoute,
        common_1.Location])
