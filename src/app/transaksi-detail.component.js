...
var TransaksiDetailComponent = (function () {
    function TransaksiDetailComponent(transaksiService, route, location) {
        ...
        this.transaksi = { id: 1, id_pasien: 1, no_sep: '01312304', nama_pasien: 'Jonathan', harga: 1000000, tanggal: '21-02-1996', status: 'open', tindakan: [{ nama: 'operasi', harga: 500000 }, { nama: 'suntik HIV', harga: 500000 }], obat: [{ nama: 'betadine', jumlah: '1', satuan: 'botol', harga: 500000 }] }; //mock-up
    }
